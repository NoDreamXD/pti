...
<body>
  ...
  if (isset($_POST['write'])) {
    ...
    $sql = "INSERT INTO wedding_salon_messages (name, email, phone_number, address, letter_theme, message) VALUES ('{$_POST["Name"]}', '{$_POST["Email"]}', '{$_POST["Phone_number"]}', '{$_POST["Address"]}', '{$_POST["Letter_theme"]}', '{$_POST["Message"]}')";
